...
const ContactSection = () => {
  return (
    <div className='flex flex-col space-y-5 md:items-center md:flex-row md:justify-between py-5 px-7 md:px-10 bg-primary mx-5 md:mx-10 xl:mx-15 rounded-xl mt-8'>
