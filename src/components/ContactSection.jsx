...
const ContactSection = () => {
  return (
    <div className='flex flex-col space-y-5  md:flex-row md:justify-between py-5 px-7 md:px-10 bg-primary mx-5 md:mx-10 xl:mx-15 rounded-xl mt-8'>
        <div className='text-white text-3xl font-extrabold md:w-[40%] border'>STAY UPTO DATE ABOUT OUR LATEST OFFERS</div>
        <div className='w-full md:w-[40%] justify-self-right flex flex-col border border-white space-y-3'>
